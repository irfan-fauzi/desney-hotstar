...
const ColorGenre = () => {
  ...
  return (
    ...
    <Slider {...settingsLists}>
      ...
      <button onClick={() => router.push('/genre/28')} className={`rounded-full text-sm py-5 px-5 -ml-28  bg-black text-white border border-gray-500`}><GiBoxingGlove size={20} className='inline-block mr-2' />Action</button>
