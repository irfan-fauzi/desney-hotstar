...
const ListMenuHeader = () => {
  ...
  return (
    <><ul className='flex gap-10 text-[1rem] lg:hidden lg:flex-row flex-col text-center '>
      <Link href={`/genre/28`}>
    ...
    <ul className='hidden lg:flex gap-10 text-[1rem] lg:flex-row flex-col text-center'>
        <Link href={`/genre/28`}>
          <a>
            <li>Action</li>
          </a>
