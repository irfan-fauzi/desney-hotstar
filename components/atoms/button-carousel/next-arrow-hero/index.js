...
const NextArrowHero = (props) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
    ><BsChevronCompactRight className='lg:text-transparent lg:hover:text-white transition text-yellow-400 text-lg lg:text-3xl relative -top-10 lg:-top-40 lg:static' /></div>
  );
}
