...
const PrevArrowHero = (props) => {
  ...
  <div
      ...
      onClick={onClick}
    ><BsChevronCompactLeft className='lg:text-white lg:hover:text-white transition text-yellow-400 text-lg lg:text-3xl relative -top-30 lg:-top-40 lg:static' /></div>
  )
}
